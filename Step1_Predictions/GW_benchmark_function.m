function [] = GW_benchmark_function(trnwin, demeanX, demeanY)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if saveon==1
    ...
    save([save_path '/gybench-trnwin-' num2str(trnwin) '-stdize-' num2str(stdize)  '-demeanX-' num2str(demeanX) '-demeanY-' num2str(demeanY) '.mat'],'timing_gy','Yprd_gy','Hat_gy');
end
