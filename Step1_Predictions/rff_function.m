function [] = rff_function(gamma, trnwin, iSim, stdize, demeanX, demeanY)
...
% saving string
para_str = strcat('maxP-', num2str(maxP), '-trnwin-', num2str(trnwin), '-gamma-', num2str(gamma), '-stdize-', num2str(stdize), '-demeanX-', num2str(demeanX), '-demeanY-', num2str(demeanY));
