function [] = GW_best_benchmark_function(trnwin, demeanX, demeanY)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
Hat_gy      = Hat;
if saveon==1
    save_path = strcat('./rff_SeparateSims/');
    save([save_path '/best-gybench-trnwin-' num2str(trnwin) '-stdize-' num2str(stdize)  '-demeanX-' num2str(demeanX) '-demeanY-' num2str(demeanY) '.mat'],'timing_gy','Yprd_gy','Hat_gy');
end
